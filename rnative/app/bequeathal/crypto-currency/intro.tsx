/**
 * Cryptocurrency Intro Screen
 * 
 * Educational screen introducing cryptocurrency tracking for estate planning.
 * Emphasizes the importance of planning for digital assets.
 * 
 * Navigation:
 * - Back: Returns to previous screen (Categories)
 * - Forward: Navigates to cryptocurrency entry screen
 */
...
export default function CryptoCurrencyIntroScreen() {
  ...
  const handleLearnMore = () => {
    Linking.openURL('https://www.gov.uk/hmrc-internal-manuals/inheritance-tax-manual/ihtm12000');
  };
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <View style={styles.iconCircle}>
            <IconButton icon="bitcoin" size={20} iconColor={KindlingColors.navy} />
          </View>
      ...
      >
        <View style={styles.content}>
          ...
          {/* Information Card */}
          <InformationCard title="Digital Assets Need Planning">
            <Text style={styles.infoText}>
              Cryptocurrency and digital assets require special consideration in estate planning because they exist only as digital keys and wallet addresses.
            </Text>
            
            <Text style={styles.infoText}>
              Without proper planning, <Text style={styles.bold}>your digital assets could be lost forever</Text> when you pass away.
            </Text>
            
            <Text style={styles.infoText}>
              We'll help you document your holdings and create a secure way for your executors to access them.
            </Text>

            <TouchableOpacity onPress={handleLearnMore} style={styles.learnMoreButton}>
              <Text style={styles.learnMoreText}>Learn about cryptocurrency inheritance planning</Text>
