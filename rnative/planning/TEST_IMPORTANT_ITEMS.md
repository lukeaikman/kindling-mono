...
| A-4 | Back button works               | Tap back arrow.                                                  | Returns to previous screen (estate dashboard or category picker).                                                         | Pass  |
...
| #   | Test                        | Steps                                                                                                                    | Pass criteria                                                                                                                                                       | Pass? |
| ----- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| B-1 | Add item — single person   | Title = "Wedding Ring". Beneficiary = Jane Doe (Daughter). Value = £2,500. Tap "Add this item".                         | Navigates to summary. Asset visible: title "Wedding Ring", value £2,500. Data viewer:`type === 'important-items'`, `estimatedValue === 2500`, `netValue === 2500`. | Pass  |
| B-2 | Add item — multiple people | Title = "Grandfather Clock". Beneficiaries = John Smith + Bob Smith. Value = £8,000. Save.                              | Asset saved.`beneficiaryAssignments.beneficiaries` has 2 entries. Both type `person`.                                                                               | Pass  |
| B-3 | Add item — The Estate      | Title = "Antique Desk". Beneficiary = The Estate. Value = £1,200. Save.                                                 | Asset saved. Beneficiary entry:`id === 'estate'`, `type === 'estate'`.                                                                                              | Pass  |
...
| C-5 | Create group via drawer    | Tap "Create / Manage Groups" in beneficiary dropdown. Select "Bloodline Children" template. Create group. | Drawer closes. Group appears as chip in beneficiaries. Group icon visible.                       | Pass           |
...
| #   | Test                           | Steps                                                                    | Pass criteria                                                                              | Pass? |
| ----- | -------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | ------- |
| F-1 | Title required                 | Leave title blank. Select beneficiary. Enter value. Check submit button. | Submit button disabled. Attention label shows "Title" required.                            | Pass  |
| F-2 | Beneficiary required           | Enter title. Leave beneficiary empty. Enter value.                       | Submit button disabled. Attention label shows "Beneficiaries" required.                    | Pass  |
| F-3 | Value required (> 0)           | Enter title. Select beneficiary. Leave value at 0.                       | Submit button disabled. Attention label shows "Estimated Value" required.                  | Pass  |
| F-4 | All three missing              | Open fresh form. Don't fill anything. Tap attention label.               | Attention label shows first invalid field. ScrollView scrolls to relevant field.           | Pass  |
